...
console.log("%d%% 할인", 80)
console.dir(obj)
// 배열에 객체를 담아 넣으면 객체 속성들이 테이블 형식으로 표현됨
...
/* console.assert() 메서드는 조건이 false일 때만 메세지를 출력. 검증이 잘 되면 아무것도 출력하지 않음 */
console.assert(1 + 1 === 2, "1 + 1 should be 2") // 출력되지 않음
